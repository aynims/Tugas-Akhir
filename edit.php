         ...
         <form method="post" action="proses-edit.php">
            <input type="hidden" name="id_pasien" value="<?= $pasien['id_pasien'];?>">
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" name="kelamin" value="<?= $pasien['kelamin'];?>">
                </div>
                ...
                <button type="submit" class="btn btn-outline-success" name="simpan">Simpan</button>&nbsp&nbsp<button type="simpan" class="btn btn-outline-primary" name="kembali">Kembali</button>
